...
public class Heap <E> {
    ...
    /**Create a default heap using a neutral order for comparison */
    /**generic comparator */
    public Heap()
    {
    ...
    public void add(E newObject)
    {
        ...
        while(currentIndex > 0)
        {
            ...
            // Swap of the current object is greater than its parent
    ...
    public E remove() {
        ...
        // After we removed we gotta lil data stream fixin todo
        int currentIndex = 0;
    ...
    /** Get the number if nodes are in the tree */
    public int getSize()
    {
        return list.size();
    }
    /** Return true of heap is empty*/
